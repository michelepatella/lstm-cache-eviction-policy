...
# Data Loader
# ----------------------------
DATA_LOADER_BATCH_WITH_TARGET_DIMENSION = 3
...
DATASET_MISSING_VALUES_REMOVAL_DROPNA_AXIS = 0
...
LOGS_GRAFANA_LOKI_FIELD_PHASE_DEFAULT = "unknown"
LOGS_GRAFANA_LOKI_FIELD_LEVEL_NAME = "level"
LOGS_GRAFANA_LOKI_FIELD_MESSAGE_NAME = "message"

LOGS_ENV_VAR_GRAFANA_LOKI_URL_NAME = "GRAFANA_LOKI_URL"
LOGS_ENV_VAR_GRAFANA_LOKI_USER_ID = "GRAFANA_LOKI_USER_ID"
LOGS_ENV_VAR_GRAFANA_LOKI_TOKEN = "GRAFANA_LOKI_TOKEN"
LOGS_ENV_VAR_GRAFANA_LOKI_LOGS_URL = "GRAFANA_LOKI_LOGS_URL"
LOGS_GRAFANA_LOKI_URL = os.getenv(LOGS_ENV_VAR_GRAFANA_LOKI_URL_NAME, "")
LOGS_GRAFANA_LOKI_USER_ID = os.getenv(LOGS_ENV_VAR_GRAFANA_LOKI_USER_ID, "")
LOGS_GRAFANA_LOKI_TOKEN = os.getenv(LOGS_ENV_VAR_GRAFANA_LOKI_TOKEN, "")
LOGS_GRAFANA_LOKI_LOGS_URL = os.getenv(LOGS_ENV_VAR_GRAFANA_LOKI_LOGS_URL, "")

LOGS_GRAFANA_LOKI_API_PAYLOAD_STREAMS_NAME = "streams"
LOGS_GRAFANA_LOKI_API_PAYLOAD_STREAM_NAME = "stream"
LOGS_GRAFANA_LOKI_API_PAYLOAD_VALUES_NAME = "values"
LOGS_GRAFANA_LOKI_API_HEADERS = {"Content-Type": "application/json"}

LOGS_GRAFANA_LOKI_ASYNC_THREAD_DAEMON = True
...
TRAINING_DDP_WORKERS_JOIN = True
TRAINING_DDP_BACKEND_NCCL = "nccl"
TRAINING_DDP_BACKEND_GLOO = "gloo"
TRAINING_DDP_ENV_VAR_MASTER_BASE_URL_NAME = "TRAINING_DDP_MASTER_BASE_URL"
TRAINING_DDP_INIT_METHOD = os.getenv(
    TRAINING_DDP_ENV_VAR_MASTER_BASE_URL_NAME,
    "",
)
TRAINING_DDP_MASTER_PROCESS_RANK = 0
