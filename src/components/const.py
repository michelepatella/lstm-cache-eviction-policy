...
GRAFANA_LOKI_URL = os.getenv(LOGS_ENV_VAR_GRAFANA_LOKI_URL_NAME, "")
GRAFANA_LOKI_USER_ID = os.getenv(LOGS_ENV_VAR_GRAFANA_LOKI_USER_ID, "")
GRAFANA_LOKI_TOKEN = os.getenv(LOGS_ENV_VAR_GRAFANA_LOKI_TOKEN, "")

LOGS_GRAFANA_LOKI_LABEL_PHASE_NAME = "env"
LOGS_GRAFANA_LOKI_LABEL_PHASE_NAME = ""
...
TRAINING_ENV_VAR_MASTER_BASE_URL_NAME = "TRAINING_MASTER_BASE_URL"
TRAINING_INIT_METHOD = os.getenv(TRAINING_ENV_VAR_MASTER_BASE_URL_NAME, "")
