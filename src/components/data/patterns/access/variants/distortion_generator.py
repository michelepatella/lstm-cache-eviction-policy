...
def generate_distortion_pattern(
    ...
    intervals corrective access is made based on history, otherwise noisy access
    is generated by adding random noise to the last accessed key.

    Args:
        distortion_interval (int): Number of requests between corrective accesses.
        distortion_history (int): Steps back in the requests history to pick the key
                                  for correction.
    ...
    Raises:
        RuntimeError: If generating the distortion pattern fails:
            ...
            * Using invalid numeric arguments or ranges (TypeError, ValueError).
            * Random noise generation or arithmetic operations fail due to invalid
