...
from variants.data.patterns.access.variants.distortion_generator import (
    generate_distortion_pattern,
)
from variants.data.patterns.access.variants.memory_fallback_generator import (
    generate_memory_fallback_pattern,
)
from variants.data.patterns.access.variants.repetition_generator import (
    generate_repetition_pattern,
)
from variants.data.patterns.access.variants.toggle_generator import (
