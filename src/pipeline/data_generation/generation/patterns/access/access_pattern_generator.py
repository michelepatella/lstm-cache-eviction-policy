...
from pipeline.data_generation.generation.patterns.access.patterns.distortion_pattern_generator import (
    generate_distortion_pattern,
)
from pipeline.data_generation.generation.patterns.access.patterns.memory_fallback_pattern_generator import (
    generate_memory_fallback_pattern,
)
from pipeline.data_generation.generation.patterns.access.patterns.repetition_pattern_generator import (
