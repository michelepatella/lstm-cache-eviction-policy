...
from pipeline.steps.data_generation.patterns.access.components.distortion_generator import (
    generate_distortion_pattern,
)
from pipeline.steps.data_generation.patterns.access.components.memory_fallback_generator import (
    generate_memory_fallback_pattern,
)
from pipeline.steps.data_generation.patterns.access.components.repetition_generator import (
